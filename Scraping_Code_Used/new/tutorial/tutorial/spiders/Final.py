...
class MSpider(scrapy.Spider):
    ...
    def parse_movies(self, response):     #parses and extracts info from one movie page at a time
        ...
        Title2 = response.xpath('//td/font/b/text()').extract()[:3]
        ...
        #F_Series1= response.xpath('//tr/td/font[@size="2"]/a/b/text()').extract()[2]
        List1 = response.xpath('//tr/td/font[@size="2"]/a/b/text()').extract()
        ...
        '''
        gross_selector1 = '//font[contains(text(), "Series:")]/b'
        F_Series3 = (driver.find_element_by_xpath(gross_selector1).text)
        '''
...
'''     
   ...
   scrapy crawl (name= movies_data ---->in the class defined above) -o (name of data file).json
''' 
